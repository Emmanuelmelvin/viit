...
const USAGE: Record<string, string> = {
  ...
  reset: "viit reset [--soft|--mixed|--hard] <commit|branch|tag|HEAD>",
  restore: "viit restore [--staged] <file> [...files]",
  mv: "viit mv <source> <destination>",
  revert: "viit revert <commit|branch|tag|HEAD|--continue|--abort>",
  branch: "viit branch [name]",
  tag: "viit tag [-d <name> | -a <name> -m <message> | <name>]",
  reflog: "viit reflog [HEAD|branch]",
  config: "viit config [--list|--get <key>|--unset <key>|<key> [value]]",
  description: "viit description [text]",
  ...
  checkout: "viit checkout <commit|branch|tag|HEAD>",
...
const DESCRIPTIONS: Record<string, string> = {
  ...
  config: "Read or write repository configuration.",
  description: "Read or set the repository description.",
